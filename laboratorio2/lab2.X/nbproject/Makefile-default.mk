...
SOURCEFILES_QUOTED_IF_SPACED=lab2.c ADC.c BITS_8.c UART.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/lab2.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/BITS_8.p1 ${OBJECTDIR}/UART.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/lab2.p1.d ${OBJECTDIR}/ADC.p1.d ${OBJECTDIR}/BITS_8.p1.d ${OBJECTDIR}/UART.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/lab2.p1 ${OBJECTDIR}/ADC.p1 ${OBJECTDIR}/BITS_8.p1 ${OBJECTDIR}/UART.p1

# Source Files
SOURCEFILES=lab2.c ADC.c BITS_8.c UART.c
...
${OBJECTDIR}/BITS_8.p1: BITS_8.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/BITS_8.p1.d 
	@${RM} ${OBJECTDIR}/BITS_8.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/BITS_8.p1 BITS_8.c 
	@-${MV} ${OBJECTDIR}/BITS_8.d ${OBJECTDIR}/BITS_8.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/BITS_8.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
