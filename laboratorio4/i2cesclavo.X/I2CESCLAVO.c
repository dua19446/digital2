 ...
 * Author: duart
 *
 * Created on 8 de agosto de 2021, 01:37 AM
 */
...
uint8_t C;
uint8_t GUARDADO;//variable para guardar el valor de adresh
//*****************************************************************************
...
void __interrupt() isr(void){
   if(PIR1bits.SSPIF == 1){ 
        ...
        if(!SSPSTATbits.D_nA && !SSPSTATbits.R_nW) {
            ...
            GUARDADO = SSPBUF;             // Guardar en el PORTD el valor del buffer de recepción
            __delay_us(250);
